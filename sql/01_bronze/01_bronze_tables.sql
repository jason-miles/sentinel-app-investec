...
CREATE TABLE IF NOT EXISTS investec_fraud_aml_bronze.customers (
  ...
  city               STRING,
  country            STRING,
  segment            STRING,      -- Investec Private Bank product tier
...
CREATE TABLE IF NOT EXISTS investec_fraud_aml_bronze.aml_knowledge (
  doc_id       STRING,
...
CREATE TABLE IF NOT EXISTS investec_fraud_aml_bronze.sar_narratives (
  sar_id       STRING,
  filed_at     DATE,
  typology     STRING,
