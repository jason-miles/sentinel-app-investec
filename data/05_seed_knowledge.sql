-- Investec — Fraud & AML SAMPLE DATA · Synthetic seeder (5/5): AML KNOWLEDGE + SAR CORPUS
-- *** INVESTEC BANK DEMO DATA — 100% SYNTHETIC ***
-- Unstructured RAG grounding for the copilot's policy agent and SAR drafting: a
-- Investec-branded AML policy + escalation matrix, FATF typology guides, and historical
-- FIC-format STR narratives filed as "Investec Bank Limited".
...
SELECT * FROM VALUES
  ...
  ('ESC-001','escalation_matrix','Alert Escalation Matrix','internal',
   ...
   'Investec Escalation Matrix (synthetic)', current_timestamp()),
