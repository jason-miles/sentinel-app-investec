-- Investec — Fraud & AML SAMPLE DATA · Synthetic seeder (4/4): PLANTED SCENARIOS
-- *** INVESTEC BANK DEMO DATA — 100% SYNTHETIC, NO REAL CLIENTS ***
...
-- Every name is obviously synthetic; subject mailboxes use @demo.investec.co.za.
--
-- Investec framing: the headline typology is a MONEY-MULE / LAUNDERING NETWORK
-- operating through ordinary Investec Private Bank accounts — the dominant financial-
...
-- ═══════════════════════════════════════════════════════════════════════════
-- Synthetic subjects on Investec Private Bank accounts.
INSERT INTO investec_fraud_aml_bronze.customers
...
VALUES
  ('CUSTFRAUD01','Sipho Dlamini', DATE'1990-03-12','ID7000000001','TAX700000001','sdlamini@demo.investec.co.za','+27820000001','14 Vilakazi St','Soweto','South Africa','private_client','tier2','Small trader', 20000.0, false,'Self','DEVFRAUD0001', TIMESTAMP'2020-01-05 09:00:00','branch','crm', current_timestamp()),
  ('CUSTFRAUD02','Naledi Khumalo', DATE'1995-08-22','ID7000000002','TAX700000002','nkhumalo@demo.investec.co.za','+27820000002','27 Klipfontein Rd','Mitchells Plain','South Africa','private_bank','tier1','Retail worker', 12000.0, false,'Shoprite Holdings','DEVFRAUD0002', TIMESTAMP'2019-06-15 09:00:00','app','crm', current_timestamp()),
  ('CUSTFRAUD03','Bongani Zulu', DATE'1988-11-02','ID7000000003','TAX700000003','bzulu@demo.investec.co.za','+27820000003','3 Govan Mbeki Ave','Mthatha','South Africa','private_client','tier2','Driver', 15000.0, false,'Self','DEVFRAUD0003', TIMESTAMP'2018-02-20 09:00:00','branch','crm', current_timestamp()),
  ('CUSTFRAUD04','Chloe Adams', DATE'1993-05-30','ID7000000004','TAX700000004','cadams@demo.investec.co.za','+27820000004','41 Church St','Bloemfontein','South Africa','wealth','tier2','Self-employed', 40000.0, false,'Self','DEVFRAUD0004', TIMESTAMP'2021-09-01 09:00:00','app','crm', current_timestamp()),
  ('CUSTFRAUD05','Thabo Mokoena', DATE'1985-01-19','ID7000000005','TAX700000005','tmokoena@demo.investec.co.za','+27820000005','5 Main St','Polokwane','South Africa','business','tier3','Self-employed', 60000.0, true,'Self','DEVFRAUD0005', TIMESTAMP'2020-07-11 09:00:00','branch','crm', current_timestamp());

-- Ring + passthrough + travel accounts (fixed IDs) ------------------------
INSERT INTO investec_fraud_aml_bronze.accounts VALUES
  ('ACCFRAUD01','CUSTFRAUD01','private_bank_account','ZAR', TIMESTAMP'2020-01-06 09:00:00','active', cast(date_sub(current_date(),1) AS TIMESTAMP), 82000.00,'crm', current_timestamp()),
  ('ACCFRAUD02','CUSTFRAUD02','private_bank_account','ZAR', TIMESTAMP'2019-06-16 09:00:00','active', cast(date_sub(current_date(),1) AS TIMESTAMP), 54000.00,'crm', current_timestamp()),
  ('ACCFRAUD03','CUSTFRAUD03','private_bank_account','ZAR', TIMESTAMP'2018-02-21 09:00:00','active', cast(date_sub(current_date(),1) AS TIMESTAMP), 31000.00,'crm', current_timestamp()),
  ('ACCFRAUD04','CUSTFRAUD04','private_bank_account','ZAR', TIMESTAMP'2021-09-02 09:00:00','active', cast(date_sub(current_date(),1) AS TIMESTAMP), 27500.00,'crm', current_timestamp()),
  -- passthrough (rapid movement) mule account
  ('ACCFRAUD05','CUSTFRAUD05','private_bank_account','ZAR', TIMESTAMP'2020-07-12 09:00:00','active', cast(date_sub(current_date(),1) AS TIMESTAMP), 9000.00,'crm', current_timestamp()),
  ...
  -- ATO target account
  ('ACCATO01','CUSTFRAUD04','private_bank_account','ZAR', TIMESTAMP'2021-09-02 09:00:00','active', cast(date_sub(current_date(),2) AS TIMESTAMP), 41000.00,'crm', current_timestamp());
...
INSERT INTO investec_fraud_aml_bronze.card_transactions
...
VALUES
  ...
  ('CUSTMULE00','Kabelo Motaung', DATE'1987-04-18','ID7100000010','TAX710000010','kmotaung@demo.investec.co.za','+27829000010','88 Recruiter St','Soweto','South Africa','business','tier2','Self-employed', 30000.0, false,'Self','DEVMULE00A1', cast(date_sub(current_date(),40) AS TIMESTAMP),'branch','crm', current_timestamp()),
  -- 7 mules: shared address + shared device + shared IP, onboarded within 3 weeks
  ('CUSTMULE01','Lerato Sithole', DATE'2000-02-01','ID7100000011','TAX710000011','mule1@demo.investec.co.za','+27829000011','88 Recruiter St','Soweto','South Africa','private_bank','tier1','Student', 5000.0, false,'Self','DEVMULE0001', cast(date_sub(current_date(),35) AS TIMESTAMP),'app','crm', current_timestamp()),
  ('CUSTMULE02','Andile Mbeki', DATE'1999-07-14','ID7100000012','TAX710000012','mule2@demo.investec.co.za','+27829000011','88 Recruiter St','Soweto','South Africa','private_bank','tier1','Student', 5000.0, false,'Self','DEVMULE0001', cast(date_sub(current_date(),33) AS TIMESTAMP),'app','crm', current_timestamp()),
  ('CUSTMULE03','Zinhle Nkosi', DATE'2001-11-30','ID7100000013','TAX710000013','mule3@demo.investec.co.za','+27829000011','88 Recruiter St','Soweto','South Africa','private_bank','tier1','Unemployed', 4000.0, false,'Self','DEVMULE0001', cast(date_sub(current_date(),31) AS TIMESTAMP),'app','crm', current_timestamp()),
  ('CUSTMULE04','Tebogo Radebe', DATE'1998-05-09','ID7100000014','TAX710000014','mule4@demo.investec.co.za','+27829000011','88 Recruiter St','Soweto','South Africa','private_bank','tier1','Student', 5000.0, false,'Self','DEVMULE0001', cast(date_sub(current_date(),29) AS TIMESTAMP),'app','crm', current_timestamp()),
  ('CUSTMULE05','Ayanda Dube', DATE'2000-09-21','ID7100000015','TAX710000015','mule5@demo.investec.co.za','+27829000011','88 Recruiter St','Soweto','South Africa','private_bank','tier1','Unemployed', 4000.0, false,'Self','DEVMULE0001', cast(date_sub(current_date(),27) AS TIMESTAMP),'app','crm', current_timestamp()),
  ('CUSTMULE06','Sibusiso Ngcobo', DATE'1997-12-03','ID7100000016','TAX710000016','mule6@demo.investec.co.za','+27829000011','88 Recruiter St','Soweto','South Africa','private_bank','tier1','Student', 5000.0, false,'Self','DEVMULE0001', cast(date_sub(current_date(),25) AS TIMESTAMP),'app','crm', current_timestamp()),
  ('CUSTMULE07','Palesa Mahlangu', DATE'1999-03-27','ID7100000017','TAX710000017','mule7@demo.investec.co.za','+27829000011','88 Recruiter St','Soweto','South Africa','private_bank','tier1','Student', 5000.0, false,'Self','DEVMULE0001', cast(date_sub(current_date(),24) AS TIMESTAMP),'app','crm', current_timestamp());

INSERT INTO investec_fraud_aml_bronze.accounts VALUES
  ('ACCMULE00','CUSTMULE00','private_bank_account','ZAR', cast(date_sub(current_date(),40) AS TIMESTAMP),'active', cast(date_sub(current_date(),1) AS TIMESTAMP), 5000.00,'crm', current_timestamp()),
  ('ACCMULE01','CUSTMULE01','private_bank_account','ZAR', cast(date_sub(current_date(),35) AS TIMESTAMP),'active', cast(date_sub(current_date(),1) AS TIMESTAMP), 1200.00,'crm', current_timestamp()),
  ('ACCMULE02','CUSTMULE02','private_bank_account','ZAR', cast(date_sub(current_date(),33) AS TIMESTAMP),'active', cast(date_sub(current_date(),1) AS TIMESTAMP), 900.00,'crm', current_timestamp()),
  ('ACCMULE03','CUSTMULE03','private_bank_account','ZAR', cast(date_sub(current_date(),31) AS TIMESTAMP),'active', cast(date_sub(current_date(),1) AS TIMESTAMP), 1500.00,'crm', current_timestamp()),
  ('ACCMULE04','CUSTMULE04','private_bank_account','ZAR', cast(date_sub(current_date(),29) AS TIMESTAMP),'active', cast(date_sub(current_date(),1) AS TIMESTAMP), 800.00,'crm', current_timestamp()),
  ('ACCMULE05','CUSTMULE05','private_bank_account','ZAR', cast(date_sub(current_date(),27) AS TIMESTAMP),'active', cast(date_sub(current_date(),1) AS TIMESTAMP), 1100.00,'crm', current_timestamp()),
  ('ACCMULE06','CUSTMULE06','private_bank_account','ZAR', cast(date_sub(current_date(),25) AS TIMESTAMP),'active', cast(date_sub(current_date(),1) AS TIMESTAMP), 950.00,'crm', current_timestamp()),
  ('ACCMULE07','CUSTMULE07','private_bank_account','ZAR', cast(date_sub(current_date(),24) AS TIMESTAMP),'active', cast(date_sub(current_date(),1) AS TIMESTAMP), 1300.00,'crm', current_timestamp());
...
INSERT INTO investec_fraud_aml_bronze.customers
  (customer_id, full_name, dob, national_id, tax_number, email, phone, address, city, country,
   ...
   device_id, onboarded_at, onboarding_channel, source_system, _ingested_at)
VALUES
  ('CUSTGAME01','Werner Pretorius', DATE'1986-06-15','ID7200000021','TAX720000021','wpretorius@demo.investec.co.za','+27829100021','12 Retief St','Pretoria','South Africa','wealth','tier2','Self-employed', 35000.0, false,'Self','DEVGAME0001', cast(date_sub(current_date(),400) AS TIMESTAMP),'app','crm', current_timestamp()),
  ('CUSTGAME02','Fatima Ismail', DATE'1991-10-08','ID7200000022','TAX720000022','fismail@demo.investec.co.za','+27829100022','7 Marine Dr','Durban','South Africa','private_client','tier2','Small trader', 28000.0, false,'Self','DEVGAME0002', cast(date_sub(current_date(),380) AS TIMESTAMP),'app','crm', current_timestamp());

INSERT INTO investec_fraud_aml_bronze.accounts VALUES
  ('ACCGAME01','CUSTGAME01','private_bank_account','ZAR', cast(date_sub(current_date(),400) AS TIMESTAMP),'active', cast(date_sub(current_date(),1) AS TIMESTAMP), 46000.00,'crm', current_timestamp()),
  ('ACCGAME02','CUSTGAME02','private_bank_account','ZAR', cast(date_sub(current_date(),380) AS TIMESTAMP),'active', cast(date_sub(current_date(),1) AS TIMESTAMP), 38000.00,'crm', current_timestamp());
...
INSERT INTO investec_fraud_aml_bronze.customers
  (customer_id, full_name, dob, national_id, tax_number, email, phone, address, city, country,
   ...
   device_id, onboarded_at, onboarding_channel, source_system, _ingested_at)
VALUES
  ('CUSTDUP01','Jan van der Merwe', DATE'1979-02-14','ID7300000031','TAX730000031','jvdm@demo.investec.co.za','+27829200031','5 Loop St','Cape Town','South Africa','private_client','tier2','Self-employed', 30000.0, false,'Blue Crane Logistics','DEVDUP0001', cast(date_sub(current_date(),700) AS TIMESTAMP),'branch','crm', current_timestamp()),
  ('CUSTDUP02','J. v.d. Merwe',      DATE'1979-02-14','ID7300000031','TAX730000031','janvdm2@demo.investec.co.za','+27829200031','5 Loop Street','Cape Town','South Africa','private_client','tier1','Self employed', 30000.0, false,'Blue Crane Logistix','DEVDUP0001', cast(date_sub(current_date(),500) AS TIMESTAMP),'app','tabular', current_timestamp()),
  ('CUSTDUP03','Johannes vdMerwe',   DATE'1979-02-14','ID7300000031','TAX730000031','jvandermerwe@demo.investec.co.za','+27829200099','5A Loop St','Cape Town','South Africa','wealth','tier2','Self-employed', 30000.0, false,'Bluecrane Logistics','DEVDUP0009', cast(date_sub(current_date(),300) AS TIMESTAMP),'agent','data_vault', current_timestamp());

INSERT INTO investec_fraud_aml_bronze.accounts VALUES
  ('ACCDUP01','CUSTDUP01','private_bank_account','ZAR', cast(date_sub(current_date(),700) AS TIMESTAMP),'active', cast(date_sub(current_date(),1) AS TIMESTAMP), 42000.00,'crm', current_timestamp()),
  ...
  ('ACCDUP03','CUSTDUP03','private_bank_account','ZAR', cast(date_sub(current_date(),300) AS TIMESTAMP),'active', cast(date_sub(current_date(),1) AS TIMESTAMP), 26000.00,'crm', current_timestamp());
...
CREATE TABLE IF NOT EXISTS investec_fraud_aml_gold.alert_feedback (
  feedback_id      STRING,
  alert_id         STRING,
  status           STRING,
...
INSERT INTO investec_fraud_aml_gold.alert_feedback
