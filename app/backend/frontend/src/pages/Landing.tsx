  ...
  return (
    <div className="landing">
      ...
      <div className="stat-band">
        ...
        <div className="s"><div className="n">R500m+</div><div className="l">Fraud Losses Prevented</div></div>
        <div className="s"><div className="n">R600bn+</div><div className="l">Client Assets Under Management</div></div>
      </div>
      ...
      <div className="footer-band">
        ...
        <div className="f"><div className="l">Card Payments</div><div className="v">High-value, low-volume</div></div>
