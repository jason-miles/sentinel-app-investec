...
GENIE_SPACE = os.environ.get("SENTINEL_GENIE_SPACE", "REPLACE_WITH_INVESTEC_GENIE_SPACE_ID")
...
def exec_briefing():
    ...
    prompt = (
        "You are a Chief Compliance Officer's AI analyst for Investec Bank Limited, a South "
